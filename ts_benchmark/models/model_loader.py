...
def get_plugin_hyper_params(
    ...
    model_hyper_params.update(model_config.get("plugin_hyper_params", {}))
    missing_hp = set(required_hyper_params) - set(model_hyper_params)
    if missing_hp:
        raise ValueError("These hyper parameters are missing : {}".format(missing_hp))
    return model_hyper_params
...
class ModelFactory:
    ...
    def __init__(
        ...
        # self.plugin_hyper_params = plugin_hyper_params
        # self.model_hyper_params['plugin'] = self.plugin_hyper_params
...
def get_models(all_model_config: Dict) -> List[ModelFactory]:
    ...
    for model_config in all_model_config["models"]:
        ...
        plugin_hyper_params = get_plugin_hyper_params(
            {},
            {},
            model_config,
        )

        model_hyper_params['plugin']=plugin_hyper_params
